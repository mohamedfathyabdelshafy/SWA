      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          content: Column(
            ...
            children: [
              // You need to determine if it's a URL or Base64 string
              // For simplicity, assuming it's a URL or can be directly loaded by Image.network
              // If it's Base64, you'll need `Image.memory(base64Decode(imageUrlOrBase64))`
              Image.network(
                imageUrlOrBase64,
                fit: BoxFit.contain,
              ...
              Text(
                LanguageClass.isEnglish ? "Image Details" : "تفاصيل الصورة",
                style: const TextStyle(fontWeight: FontWeight.bold),
              ),
              // You might want to add more details here if the API provides them
            ],
          ),
          actions: <Widget>[
            TextButton(
