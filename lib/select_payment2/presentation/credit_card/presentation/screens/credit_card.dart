              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border(
                          left: BorderSide(
                              width: 1, color: Routes.isomra ? AppColors.umragold : AppColors.primaryColor))),
                  child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty || value.trim().length != 19) {
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintStyle: fontStyle(
                                      fontSize: 21, fontFamily: FontFamily.regular, color: const Color(0xffA3A3A3))),
                            ),
                          ),
                        ],
                      ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: fontStyle(fontFamily: FontFamily.regular, fontSize: 11, color: const Color(0xff39A85B)),
                      ),
                    ],
                  ),
                ),
...
class ExpiryDateInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    if (text.length >= 2) {
      ...
      var monthInt = int.tryParse(month) ?? 0;
      if (monthInt > 12 || monthInt <= 0) return oldValue;
      result += month;
      if (text.length > 2) {
        result += '/';
        var year = text.substring(2);
        if (year.length == 2) {
          var yearInt = int.tryParse(year) ?? 0;
          if (yearInt < 25) return oldValue;
        }
        result += year;
      }
    } else {
