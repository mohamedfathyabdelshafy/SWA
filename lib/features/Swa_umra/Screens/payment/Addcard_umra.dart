...
//                             decoration:
//                                 BoxDecoration(border: Border(left: BorderSide(width: 1, color: AppColors.umragold))),
//                             child: Column(
...
//                                       child: TextFormField(
//                                         style: fontStyle(
//                                             color: Colors.black, fontSize: 18, fontFamily: FontFamily.regular),
...
//                                   style: fontStyle(
//                                       fontFamily: FontFamily.regular, fontSize: 11, color: const Color(0xff39A85B)),
//                                 ),
//                               ],
//                             ),
//                           ),
...
//                                   final cachedcard =
//                                       json.decode(jsonData).map<CardModel>((e) => CardModel.fromJsom(e)).toList();
...
//                                 decoration:
//                                     BoxDecoration(color: AppColors.umragold, borderRadius: BorderRadius.circular(41)),
//                                 child: Center(
//                                   child: Text(
