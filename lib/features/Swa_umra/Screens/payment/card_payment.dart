...
class _UmracardpayState extends State<Umracardpay> {
  ...
  void initState() {
    ...
    widget.index = 0;
    amount = widget.umrahReservationID == null ? UmraDetails.afterdiscount : UmraDetails.differentPrice;
                                            ...
                                            children: [
                                                                      ...
                                                                      child: Container(
                                                                        ...
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Divider(
                                                                                thickness: 0.5, color: AppColors.grey),
                                                                            Column(
                                              ...
                                              InkWell(
                                                onTap: cards.isNotEmpty
                                                    ? () {
                                                        if (widget.index < 0 || cards.isEmpty) {
                                                          ...
                                                          if (formKey.currentState!.validate()) {
                                                            UmraDetails.cardModel = cards[widget.index];

                                                            UmraDetails.cvv = cvv;

                                                            Navigator.pop(context, cards[widget.index]);
                                                    ...
                                                    : () {
                                                        Constants.showDefaultSnackBar(
                                                            color: AppColors.umragold,
                                                            context: context,
                                                            text: LanguageClass.isEnglish ? 'Add card' : 'إضافة بطاقة');
                                                      },
                                                child: Padding(
