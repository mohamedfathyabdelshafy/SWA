                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      ...
                                      colorFilter: ColorFilter.mode(
                                          HexColor(state.packagesModel!
                                              .message![index].bgColor!),
                                          BlendMode.multiply),
                                      alignment: Alignment.center,
                                      image: NetworkImage(
                                        state.packagesModel!.message![index]
                                            .image!,
                                      ))),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${LanguageClass.isEnglish ? 'Availability' : 'المتاح'}  ${state.packagesModel!.message![index].availability!.toString()}',
                                        style: fontStyle(
                                            color: Colors.white,
                                            fontFamily: FontFamily.bold,
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Wrap(
                                          ...
                                          runSpacing: 2.w,
                                          spacing: 2.w,
                                          children: state.packagesModel!
                                              .message![index].nightList!
                                              .map((e) => FittedBox(
                                                    fit: BoxFit.fitWidth,
                                                    child: Container(
                                                      child: Text(
                                      ...
                                      InkWell(
                                        onTap: () {
                                          setState(() {
                                            ...
                                            tripumraid = state.packagesModel!
                                                .message![index].tripUmrahId!;
                                          });
                                        },
                                        child: Container(
                                          height: 40.sp,
                                          ...
                                          padding: EdgeInsets.symmetric(
                                              horizontal: 10.w,
                                              vertical: LanguageClass.isEnglish
                                                  ? 9.h
                                                  : 7.h),
                                          decoration: BoxDecoration(
                                              color: selectedtripid == index
                                                  ? Color(0xffecb959)
                                                  : Colors.white,
                                              borderRadius:
                          ...
                          opentap == index
                              ? Flexible(
                                  child: ListView.builder(
                                    itemCount: state.packagesModel!
                                        .message![index].detailsList!.length,
                                    shrinkWrap: true,
                                    physics: ScrollPhysics(),
                                    itemBuilder:
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color:
                  selectedtripid == -1 ? Color(0xffC3C3C3) : Color(0xffecb959),
                ...
                Indexer(
                    ...
                    children: List.generate(
                        ...
                        (index) => Indexed(
                              ...
                              child: InkWell(
                                onTap: () {
                                  final selectedItem = listcampains![index];

                                  // Update selected ID
                                  UmraDetails.campainid =
                                      selectedItem.campiagnUmraId!;

                                  // Dispatch the event
                                  _umraBloc.add(GetPackageListEvent(
                                    reservationid: widget.umrahReservationID,
                                    campianID: selectedItem.campiagnUmraId!,
                                    city: widget.city,
                                    date: widget.date,
                                  ...
                                  setState(() {
                                    // Move the selected item to the first index
                                    listcampains!.removeAt(index);
                                    listcampains!.insert(0, selectedItem);
                                    selectedpackage = 0;
                                  });
                                },
                                child: AnimatedContainer(
                                  ...
                                  width: selectedpackage == index ? 140 : 120,
                                  height: 47,
                ...
                child: selectedtripid != -1
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                            color: Colors.white,
                            border:
                                Border.all(width: 2, color: AppColors.umragold),
              ...
              customdatepicker(
                ...
                onchange: (hdate) {
                  ...
                  ishijiri
                      ...
                      : selectedDate = intl.DateFormat('MM-dd-yyyy')
                          .format(date!)
                          .toString();
