...
import 'package:swa/features/Swa_umra/Screens/Widget/Umra_timer.dart';
...
class SleactseatScrean extends StatefulWidget {
  ...
  @override
  State<SleactseatScrean> createState() => _SleactseatScreanState();
}

class _SleactseatScreanState extends State<SleactseatScrean> {
  ...
  void initState() {
    ...
    _umraBloc.add(GetSeatsEvent(
        tripId: widget.tripdetails.tripList![widget.selectedpackage].tripGoId));
  }
