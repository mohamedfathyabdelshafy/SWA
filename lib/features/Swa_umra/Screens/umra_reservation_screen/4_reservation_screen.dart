          ...
          listener: (context, UmraState state) {
            if (state.reservationResponseElectronicModel?.status == 'success' &&
              ...
              showDoneConfirmationDialog(context,
                  callbackTitle:
                      LanguageClass.isEnglish ? "Go to OTP" : 'ادخل الرمز',
                  isWarning: true,
                                                                                  ...
                                                                                  : Transform.flip(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: ListView(
                                                                                          ...
                                                                                          children: [
                                                                                            // SmartAutoScrollText(
                                                                                            //   text: UmraDetails.transportList![index].from!,
                                                                                            //   width: 64.sp,
                                                                                            //   style: fontStyle(
                                                                                            //     color: Colors.black,
                                                                                            //     fontSize: 14.sp,
                                                                                            ...
                                                                                            //   ),
                                                                                            // ),
                                                                                            UmraDetails.transportList![index].from!.trim().length > 7
                                                                                                ? Container(
                                                                                                    height: 20.h,
                                                                                                    width: 64.sp,
                                                                                                    //color: Colors.green,
                                                                                  ...
                                                                                  : Transform.flip(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: ListView(
                                                                                          ...
                                                                                          scrollDirection: Axis.horizontal,
                                                                                          children: [
                                                                                            UmraDetails.transportList![index].to!.trim().length > 7
                                                                                                ? Container(
                                                                                                    height: 20.h,
                                                                                                    width: 64.sp,
                                                                                                    //color: Colors.green,
                                                                                                    child: Marquee(
                                                                                                      text: UmraDetails.transportList![index].to!,
                                                                                                      style: fontStyle(
                                                                                                        color: Colors.black,
                                                                                                        fontSize: 14.sp,
                                                                                                        fontWeight: FontWeight.w500,
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                "${UmraDetails.accomidation![index].accessDate?.replaceFirst(RegExp(r'^0+'), '')}",
                                                                style:
                                                                    fontStyle(
                                                                  fontSize:
                                                                      17.sp,
