            ...
            if (state.campainlistmodel?.status == "success") {
              ...
              if (widget.umrahReservationID != null) {
                for (int i = 0; i < transportList!.length; i++) {
                  print("TIK TIK BUS ID: ${transportList![i].busId}");
                  print("TIK TIK LINE ID: ${transportList![i].lineId}");
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: FittedBox(
                                          ...
                                          child: Text(
                                            isSuggested
                                                ? '${(selectedseats.length * transportSuggestedList![suggestedindex].priceSeat).toStringAsFixed(2)} ${Routes.curruncy ?? ""}'
                                                : '${(selectedseats.length * transportList![inn].priceSeat).toStringAsFixed(2)} ${Routes.curruncy ?? ""}',
                                            style: fontStyle(
                                              color: Colors.black,
                                              fontFamily: FontFamily.regular,
                                              fontSize: 17.sp,
                                                                      ...
                                                                      if (selectedseats.contains(state
                                                                        ...
                                                                        if (reservedseats.isNotEmpty &&
                                                                          ...
                                                                          if (reservedseats.every(
                                                                                (element) {
                                                                                  print("Tik Tik seats length: ${element.seatsnumber.length}");
                                                                                  return element.seatsnumber.length == selectedseats.length;
                                                                                },
                                                                              ) &&
                                                                              inn != 0) {
                                                                            UmraDetails.seatsNumbers.add(
                                                                              state.seatsmodel!.message!.busDetailsVm!.rowList![index].seats[i].seatNo!,
                                                                            );
                                                                            log('message');
                                                                            print("Tik Tik index: $index , inn:$inn , i:$i");
                                                                            print("Tik Tik From 2");
                                                                            OverlayEntry
                                                                                overlayEntry =
                                                                                OverlayEntry(
                                                                              builder: (context) => Positioned(
                                                                                ...
                                                                                child: Material(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: Center(
                                                                                      child: Text(
                                                                                        LanguageClass.isEnglish ? 'Select the same number of seats on all trips' : 'اختر نفس عدد المقاعد في جميع الرحلات',
                                                                                        textAlign: TextAlign.center,
                                                                                        style: fontStyle(
                                                                                          color: AppColors.primaryColor,
                                                                                          fontSize: (Device.get().isTablet) ? Theme.of(context).textTheme.labelLarge!.fontSize! : Theme.of(context).textTheme.labelMedium!.fontSize!,
                                                                            ...
                                                                            //     context: context,
                                                                            //     text: LanguageClass.isEnglish ? 'select the same number of seats on all trips' : 'اختر نفس عدد المقاعد في جميع الرحلات');
                                                                          } else {
                                                                            print("Tik Tik From 3");
                                  ...
                                  children: [
                                    ...
                                    transportList?.isEmpty == true
                                        ...
                                        : Container(
                                            ...
                                            child: Container(
                                              child: Text(
                                                "${reservedseats.length > 0 ? double.parse(reservedseats.map((item) => item.totalprice).reduce((a, b) => a + b).toString()).toStringAsFixed(2) : '0.0'} ${Routes.curruncy ?? ""}",
                                                style: fontStyle(
                                                    color: Colors.black,
                                                    fontSize: 17.sp,
                                                    fontWeight: FontWeight.w500,
                                              ...
                                              if (transportationListModel!
                                                ...
                                                if (transportList!.length ==
                                                  ...
                                                  Constants.showDefaultSnackBar(
                                                      ...
                                                      text: LanguageClass
                                                              .isEnglish
                                                          ? 'Please choose all the transportation seats'
                                                          : 'برجاء اختيار كل كراسي الرحلات');
                                                } else {
                                                  bool isRes = reservedseats
                                                      .every((element) {
                                                    print(
                                                        "All seats: ${element.seatsnumber.length}");
                                                    return element
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                _umraBloc.add(GetSeatsEvent(
                                    tripId: transportList![index].tripId));
                              },
                              child: Row(
                                children: [
                                  Container(
