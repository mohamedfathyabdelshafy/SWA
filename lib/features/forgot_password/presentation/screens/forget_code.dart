...
import 'package:swa/features/forgot_password/presentation/screens/submit_password.dart';
...
class ForgetCodeScreen extends StatefulWidget {
  ForgetCodeScreen({Key? key, required this.userId}) : super(key: key);
  String userId;
  @override
