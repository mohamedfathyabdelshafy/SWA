  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Directionality(
        ...
        child: BlocProvider(
          create: (context) => TimesTripsCubit()..getCompaniesList(),
          child: Column(
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color:
                          isSelected ? _primaryColor : const Color(0xfff3f3f3),
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected = selectedIndexDay == index;
          return GestureDetector(
            onTap: () {
              setState(() {
