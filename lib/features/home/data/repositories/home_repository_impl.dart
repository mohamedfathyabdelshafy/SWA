...
class HomeRepositoryImpl implements HomeRepository {
  ...
  @override
  Future<Either<Failure, HomeMessageResponse>> getFromStationsData(
      NoParams params) async {
    //In case there's connection
    //  try {
    print("Tik Tik getFromStationsData Started");
  ...
  @override
  Future<Either<Failure, HomeMessageResponse>> getToStationsData(
