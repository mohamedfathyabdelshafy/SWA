                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      showGeneralDialog(
                                                                              ...
                                                                              itemBuilder: (context, index) {
                                                                                return Column(
                                                                                  ...
                                                                                  children: [
                                                                                    InkWell(
                                                                                      onTap: () {
                                                        CacheHelper.setDataToSharedPref(key: 'isCountryChoosen', value: true);
                                                        ...
                                                        CacheHelper.setDataToSharedPref(
                                                          key: 'country',
                                                          value: state.countries[index].countryName,
                                                        );

                                                        Routes.country = state.countries[index].countryName;
                                                                                        print("Tik Tik Countries: ${Routes.country}");
                                                                                        setStater(() {
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          Text(
                                                            (CacheHelper.getDataToSharedPref(key: 'countryid').toString() == "3")
                                                                ? (LanguageClass.isEnglish ? "Saudi Arabia" : "السعودية")
                                                                : (CacheHelper.getDataToSharedPref(key: 'countryid').toString() == "1")
                                                                    ? (LanguageClass.isEnglish ? "Egypt" : "مصر")
                                                                    : (Routes.country == "Saudi Arabia" ? (LanguageClass.isEnglish ? "Saudi Arabia" : "السعودية") : (LanguageClass.isEnglish ? "Egypt" : "مصر")),
                                                            style: fontStyle(
                                                                color: AppColors
                                                                    .blackColor,
