                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  busSeatsModel?.message.emptySeats.toString() ?? " ",
                                  style: fontStyle(
                                      fontSize: 45, fontFamily: FontFamily.medium, color: AppColors.primaryColor),
                                ),
                              ),
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      ...
                                      style: fontStyle(color: Colors.white, fontFamily: FontFamily.bold, fontSize: 18),
                                    ),
                                  ),
                                ),
                              ),
