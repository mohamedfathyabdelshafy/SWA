            ...
            children: [
              ...
              BlocBuilder<GetAvailableCountriesCubit,
                ...
                return CustomizedField(
                  ...
                  isPassword: false,
                  obscureText: false,
                  readonly: true, // <--- This is already true
                  color: Color(0xffDDDDDD),
                  controller: countrycontroller,
                  ontap:
                      null, // <--- Set ontap to null to make it non-interactive
                  validator: (validator) {},
                  labelText: LanguageClass.isEnglish ? "Country" : "الدولة",
                );
              }),
              const SizedBox(
                height: 15,
                        ...
                        if (state is PersonalInfoError) {
                          ...
                          Constants.showDefaultSnackBar(
                              color: state.msg
                                          .toLowerCase()
                                          .contains("saved") ||
                                      state.msg.toLowerCase().contains("بنجاح")
                                  ? Colors.green
                                  : Colors.red,
                              context: context,
                              text: state.msg);
