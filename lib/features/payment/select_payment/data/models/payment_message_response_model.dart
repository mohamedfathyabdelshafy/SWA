...
class PaymentMessageResponseModel extends PaymentMessageResponse {
  ...
  }) : super(status: status, message: message, paymentMessage: paymentMessage, balance: balance, object: object, obj: obj);

  factory PaymentMessageResponseModel.fromJson(Map<String, dynamic> json) => PaymentMessageResponseModel(
    status : json['status'],
    message : (json['status'] == 'failed') ?  json['message'] : null,
    paymentMessage : (json['message'] != null && json['status'] != 'failed') ? PaymentMessageModel.fromJson(json['message']) : null,
