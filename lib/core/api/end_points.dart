class EndPoints {
  ...
  static const String submitResetPassword =
      '${baseUrl}Accounts/SubmitResetPassword';
  ...
  static const String getCompanyList = '${baseUrl}Trip/GetCompanyList';

  static const String getRecommendedList = '${baseUrl}Trip/GetTripSortDropDown';
