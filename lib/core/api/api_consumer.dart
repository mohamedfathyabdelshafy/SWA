abstract class ApiConsumer {
  ...
  Future<dynamic> put(String path, {dynamic body, Map<String, dynamic>? queryParameters});//Map<String, dynamic> instead of dynamic
//Map<String, dynamic> instead of dynamic
